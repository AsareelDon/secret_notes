...
// in secret_notes/test/src/features/secret_notes/data/datasources/notes_local_datasource_impl_test.dart.
...
class MockStore extends _i1.Mock implements _i5.Store {
  ...
  _i2.Box<T> box<T>() =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeBox_0<T>(this, Invocation.method(#box, [])),
          )
          as _i2.Box<T>);

  @override
  R runInTransaction<R>(_i8.TxMode? mode, R Function()? fn) =>
      (super.noSuchMethod(
...
class MockBox<T> extends _i1.Mock implements _i2.Box<T> {
  ...
  @override
  _i4.QueryBuilder<T> query([_i4.Condition<T>? qc]) =>
      (super.noSuchMethod(
